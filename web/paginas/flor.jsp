            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table id="customers" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nome</th>
                            ...
                            <tbody> <!--JSTL-->
                                <jsp:useBean id="dao" class="DAOs.DAOFlores"/>
                  
                                <c:set var="resultadoLista" value="${dao.listInOrderIdFlor()}"/>
                                <c:forEach var="t" items="${resultadoLista}">
                                    <tr> 
                                        <td>${t.getNomeFlor()}</td>
                                        <td>${t.getNomeFlor()}</td>
                                        <td>${t.getQuantidadeFlor()}</td>
                                        <td>${t.getPrecoFlor()}</td>
                                        <td>${t.getTipoIdTipo()}</td>
                                    </tr>
                                </c:forEach>
